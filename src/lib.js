...
const createPrompt = (input) => {
    ...
    //console.log(input)
    let questNum = (input === undefined) ? 1 : (input["numQuestions"] === undefined) ? 1 : input["numQuestions"]
    let choiceNum  = (input === undefined) ? 2 : (input["numChoices"] === undefined) ? 2 : input["numChoices"]
